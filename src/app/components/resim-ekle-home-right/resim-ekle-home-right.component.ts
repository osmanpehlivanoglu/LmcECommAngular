...
@Component({
  selector: 'app-resim-ekle-home-right',
  templateUrl: './resim-ekle-home-right.component.html',
  styleUrls: ['./resim-ekle-home-right.component.css'],
})
export class ResimEkleHomeRightComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.setResimFormUrun(2000000001);
    this.getResimlerByUrunId(2000000001);
  }
