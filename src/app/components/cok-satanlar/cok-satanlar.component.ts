...
@Component({
  selector: 'app-cok-satanlar',
  templateUrl: './cok-satanlar.component.html',
  styleUrls: ['./cok-satanlar.component.css'],
})
export class CokSatanlarComponent implements OnInit {
  ...
  getFiyatArtan() {
    this.cokSatanUrunler.sort((a, b) => a.bayiFiyati - b.bayiFiyati);
  }

  getFiyatAzalan() {
    this.cokSatanUrunler.sort((a, b) => b.bayiFiyati - a.bayiFiyati);
  }
